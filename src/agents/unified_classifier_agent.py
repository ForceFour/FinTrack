...
class UnifiedClassifierInput(BaseModel):
    """Input schema for Unified Classifier Agent"""
...
class UnifiedClassifierOutput(BaseModel):
    """Output schema for Unified Classifier Agent"""
...
class UnifiedClassifierAgent:
    """
    Unified Classification Agent combining category prediction and transaction type classification
    ...
    def process(self, input_data: UnifiedClassifierInput) -> UnifiedClassifierOutput:
        ...
        if not transactions:
            return UnifiedClassifierOutput(
